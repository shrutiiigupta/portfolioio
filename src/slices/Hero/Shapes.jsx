...
function Geometries(){
    const geometries = [
        {
            position: [0, 0, 0],
            r: 0.3,
            geometry: new THREE.IcosahedronGeometry(3) //center piece
        },
        {
            position: [1, -0.75, 4],
            r: 0.4,
        ...
        },
        {
            position: [-1, -0.75, 5],
            r: 0.5,
            geometry: new THREE.TorusKnotGeometry( 0.6, 0.2, 100, 16 ), // Knot
        },
        {
            position: [1.6, 1.6, -4],
            r: 0.7,
    ...
    const materials = [
        ...
        new THREE.MeshStandardMaterial({ color: 0x0652DD, roughness: 0.4 }),
